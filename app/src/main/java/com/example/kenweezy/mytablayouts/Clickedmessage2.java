...
public class Clickedmessage2 extends AppCompatActivity {
    ...
    private static Clickedmessage2 inst;
    ...
    public static Clickedmessage2 instance() {
        return inst;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clickedmessage2);
