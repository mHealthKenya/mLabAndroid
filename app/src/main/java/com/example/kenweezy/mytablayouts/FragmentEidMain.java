...
public class FragmentEidMain extends Fragment {

    private TabLayout tabLayout;
    private ViewPager viewPager;

    String[] tabTitle={"ALL","NEGATIVE","POSITIVE"};
    int[] unreadCount={0,0,0};
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rtv=inflater.inflate(R.layout.fragmenteidmain,container,false);

        viewPager=(ViewPager) rtv.findViewById(R.id.frageid_viewpager);
        setupViewPager(viewPager);
        tabLayout=(TabLayout) rtv.findViewById(R.id.frageid_tabs);
        ...
        unreadCount[1]=gsc.getFfeidNegativeCount();
        unreadCount[2]=gsc.getFfeidPositiveCount();
...
//        tabLayout.getTabAt(3).setIcon(R.mipmap.ic_launcher);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new FragmentEidAll(), "ALL");
        adapter.addFragment(new FragmentEidNegative(), "NEGATIVE");
        adapter.addFragment(new FragmentEidPositive(), "POSITIVE");
